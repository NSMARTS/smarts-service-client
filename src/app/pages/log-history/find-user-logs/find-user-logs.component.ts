import { Component, DestroyRef, ViewChild, WritableSignal, effect, inject, signal } from '@angular/core';
...
export class FindUserLogsComponent {
  ...
  displayedColumns: string[] = [
    'employee', 'enterTime', 'leaveTime', 'url'
  ];
      ...
      .pipe(
        ...
        switchMap(() => {
          let query: any = {
            ...
            ...this.selectedLog()?.admin?.email ? { admin: this.selectedLog().admin.email } : {},
            ...this.selectedLog()?.manager?.email ? { manager: this.selectedLog().manager.email } : {},
            ...this.selectedLog()?.employee?.email ? { employee: this.selectedLog().employee.email } : {}
          };
