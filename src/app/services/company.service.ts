...
export class CompanyService {
    ...
    getCompanyList(): Observable<HttpResMsg<Company[]>> {
        return this.http.get<HttpResMsg<Company[]>>(this.baseUrl + '/company/companies')
            .pipe(takeUntilDestroyed(this.destroyRef));
    ...
    getCompanyInfo(id: any): Observable<HttpResMsg<Company>> {
        return this.http.get<HttpResMsg<Company>>(this.baseUrl + '/company/company/' + id)
            .pipe(takeUntilDestroyed(this.destroyRef));
    ...
    editCompany(id: string, companyData: any) {
        return this.http.patch(this.baseUrl + '/company/company/' + id, companyData)
            .pipe(takeUntilDestroyed(this.destroyRef));
    }
