...
export class CountryService {
    ...
    addCountry(countryData: any) {
        return this.http.post(this.baseUrl + '/countries', countryData).pipe(takeUntilDestroyed(this.destroyRef));
    }

    // 나라 목록 불러오기
    getCountryList(): Observable<HttpResMsg<Country[]>> {
        return this.http.get<HttpResMsg<Country[]>>(this.baseUrl + '/countries').pipe(takeUntilDestroyed(this.destroyRef));
    }
    ...
    getCountryInfo(data: any) {
        ...
        return this.http.get(this.baseUrl + '/countries/holiday/' + data.countryId).pipe(takeUntilDestroyed(this.destroyRef));
    }
    ...
    deleteCountryHoliday(data: any) {
        ...
        return this.http.delete(
            this.baseUrl + '/countries/holiday/' + data.countryId).pipe(takeUntilDestroyed(this.destroyRef));
    }
}
